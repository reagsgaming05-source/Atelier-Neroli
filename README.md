...
| **Nourriture**, course d'école comprise | Rubrique *Nourriture*, en règle de trois — jamais *Autre*. Un repas au restaurant ou de grosses courses pour la classe y ont leur place. Un petit achat (bonbons, goûter) ne vaut la peine que s'il pèse — de l'ordre d'une centaine de francs pour une vingtaine d'élèves ; en dessous, décochez-le. |
| Frais de **cuisinière** (camp) | Rubrique *Cuisinière*, en règle de trois : le modèle du camp a cette ligne, donc elle sert. C'est la personne qui cuisine, pas ce qu'elle achète — sa facture parle forcément aussi de repas, et le simple décompte des mots l'aurait rangée dans *Nourriture*. La cuisine d'un chalet, elle, reste de l'hébergement. |
| Rubriques | Course d'école : Transport / Activité / **Nourriture** / Autre. Camp : Nourriture / Hébergement / Transport / Activité / Autre / Cuisinière. Seules les rubriques utilisées apparaissent dans l'Excel, comme dans les décomptes établis à la main. Le modèle n'impose pas cette liste : `excel.py` écrit le nom de la rubrique dans la colonne B, ligne par ligne. |
