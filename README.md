...
| Frais de **cuisinière** (camp) | Rubrique *Nourriture*, en règle de trois : tout ce que coûte la cuisinière y va, son salaire compris. La ligne *Cuisinière* du modèle du camp reste disponible à la main, mais rien n'y est envoyé automatiquement. La cuisine d'un chalet, elle, reste de l'hébergement. |
