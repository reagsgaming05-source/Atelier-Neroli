...
exports.decodePdfNameEscapes = void 0;
...
const decodePdfNameEscapes = (name) => name.replace(/#([0-9A-Fa-f]{2})/g, (_, hex) => (0, utils_1.charFromHexCode)(hex));
exports.decodePdfNameEscapes = decodePdfNameEscapes;
...
class PDFName extends PDFObject_1.default {
    ...
    copyBytesInto(buffer, offset) {
        (0, utils_1.copyStringIntoBuffer)(this.encodedName, buffer, offset);
        return this.encodedName.length;
    }
}
PDFName.of = (name) => {
