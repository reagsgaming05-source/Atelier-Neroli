...
const OptionalContent_1 = tslib_1.__importDefault(require("../interactive/OptionalContent"));
...
class PDFCatalog extends PDFDict_1.default {
    ...
    getOCProperties() {
        const dict = this.lookupMaybe(PDFName_1.default.of('OCProperties'), PDFDict_1.default);
        return dict && OptionalContent_1.default.fromDict(dict);
    }
    /**
