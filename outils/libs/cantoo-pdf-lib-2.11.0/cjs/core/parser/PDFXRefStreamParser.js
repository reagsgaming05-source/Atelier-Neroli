...
class PDFXRefStreamParser {
    ...
    parseIntoContext() {
        ...
        this.context.trailerInfo = {
            Size: this.dict.lookup(PDFName_1.default.of('Size'), PDFNumber_1.default) || prev.Size,
            Root: this.dict.get(PDFName_1.default.of('Root')) || prev.Root,
            Encrypt: this.dict.get(PDFName_1.default.of('Encrypt')) || prev.Encrypt,
            Info: this.dict.get(PDFName_1.default.of('Info')) || prev.Info,
            ID: this.dict.get(PDFName_1.default.of('ID')) || prev.ID,
        };
