...
const PDFJavaScriptAction_1 = tslib_1.__importStar(require("../PDFJavaScriptAction"));
...
class PDFField {
    ...
    getJavaScriptActions() {
        const aaDict = this.acroField.dict.lookupMaybe(core_1.PDFName.of('AA'), core_1.PDFDict);
        if (!aaDict)
            return undefined;
        return (0, PDFJavaScriptAction_1.extractAdditionalActions)(aaDict, this.doc, 'field');
    }
    /**
     ...
     */
    getAction() {
        const actionObj = this.acroField.dict.get(core_1.PDFName.of('A'));
        const actionDict = this.acroField.dict.lookupMaybe(core_1.PDFName.of('A'), core_1.PDFDict);
        if (!actionDict)
            return undefined;
        return PDFJavaScriptAction_1.default.of(actionDict, this.doc, actionObj instanceof core_1.PDFRef ? actionObj : undefined);
    }
    /** @ignore */
