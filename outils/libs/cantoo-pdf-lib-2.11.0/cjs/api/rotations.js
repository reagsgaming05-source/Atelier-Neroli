...
// prettier-ignore
const toRadians = (rotation) => rotation.type === RotationTypes.Radians ? rotation.angle
    : rotation.type === RotationTypes.Degrees ? (0, exports.degreesToRadians)(rotation.angle)
        : (0, utils_1.error)(`Invalid rotation: ${JSON.stringify(rotation)}`);
exports.toRadians = toRadians;
// prettier-ignore
const toDegrees = (rotation) => rotation.type === RotationTypes.Radians ? (0, exports.radiansToDegrees)(rotation.angle)
